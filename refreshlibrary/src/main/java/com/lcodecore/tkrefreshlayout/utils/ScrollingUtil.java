...
public class ScrollingUtil {
    ...
    public static boolean isViewToBottom(View view, int mTouchSlop) {
        ...
        if (view instanceof CustomNestedScrollView)
            return isCustomNestedScrollViewToBottom((CustomNestedScrollView) view);
        if (view instanceof ViewGroup) return isViewGroupToBottom((ViewGroup) view);
        return false;
    }

    private static boolean isCustomNestedScrollViewToBottom(CustomNestedScrollView view) {
